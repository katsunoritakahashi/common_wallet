class GuestsController < ApplicationController
  ...
  def create
    ...
    detail_2 = Detail.create(user_id: current_user.id, month_id: month_1.id, date: Date.today.beginning_of_month.since(10.day), classification: 4, income: rand(500..1500) * 100, replayer: "旦那", status: 0,note: "定期入金" )
