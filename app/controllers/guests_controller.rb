class GuestsController < ApplicationController
  ...
  def create
    ...
    month_2 = Month.create(user_id: current_user.id, balance: month_1.balance * rand(8..13) / 10, balance_last: month_1.balance * rand(8..13) / 10, month: Date.today.ago(1.month).beginning_of_month )
    month_3 = Month.create(user_id: current_user.id, balance: month_2.balance * rand(8..13) / 10, balance_last: month_2.balance * rand(8..13) / 10, month: Date.today.ago(2.month).beginning_of_month )
    month_4 = Month.create(user_id: current_user.id, balance: month_3.balance * rand(8..13) / 10, balance_last: month_3.balance * rand(8..13) / 10, month: Date.today.ago(3.month).beginning_of_month )
    month_5 = Month.create(user_id: current_user.id, balance: month_4.balance * rand(8..13) / 10, balance_last: month_4.balance * rand(8..13) / 10, month: Date.today.ago(4.month).beginning_of_month )
    month_6 = Month.create(user_id: current_user.id, balance: month_5.balance * rand(8..13) / 10, balance_last: month_5.balance * rand(8..13) / 10, month: Date.today.ago(5.month).beginning_of_month )
    month_7 = Month.create(user_id: current_user.id, balance: month_6.balance * rand(8..13) / 10, balance_last: month_6.balance * rand(8..13) / 10, month: Date.today.ago(6.month).beginning_of_month )
    month_8 = Month.create(user_id: current_user.id, balance: month_7.balance * rand(8..13) / 10, balance_last: month_7.balance * rand(8..13) / 10, month: Date.today.ago(7.month).beginning_of_month )
    month_9 = Month.create(user_id: current_user.id, balance: month_8.balance * rand(8..13) / 10, balance_last: month_8.balance * rand(8..13) / 10, month: Date.today.ago(8.month).beginning_of_month )
    month_10 = Month.create(user_id: current_user.id, balance: month_9.balance * rand(8..13) / 10, balance_last: month_9.balance * rand(8..13) / 10, month: Date.today.ago(9.month).beginning_of_month )
    month_11 = Month.create(user_id: current_user.id, balance: month_10.balance * rand(8..13) / 10, balance_last: month_10.balance * rand(8..13) / 10, month: Date.today.ago(10.month).beginning_of_month )
    month_12 = Month.create(user_id: current_user.id, balance: month_11.balance * rand(8..13) / 10, balance_last: month_11.balance * rand(8..13) / 10, month: Date.today.ago(11.month).beginning_of_month )
